...
/**
 * Enqueue admin scripts and styles for privacy settings
 */
function vz_enqueue_privacy_admin_assets($hook) {
  // Only load on our settings page
  if ($hook !== 'settings_page_vz-video-privacy') {
    return;
  }

  // Enqueue CSS
  wp_enqueue_style(
    'vz-privacy-templates-modal',
    plugin_dir_url(dirname(dirname(__FILE__))) . 
    'assets/css/vz-privacy-templates-modal.css',
    array(),
    '1.0.0'
  );
  ...
  wp_enqueue_script(
    'vz-privacy-templates-modal',
    plugin_dir_url(dirname(dirname(__FILE__))) . 
    'assets/js/vz-privacy-templates-modal.js',
    array('jquery'),
    '1.0.0',
    true
  );
  ...
  wp_localize_script(
    ...
    'vzPrivacyTemplates',
    array(
      'copiedText' => __('Copied!', 'vz-secure-video'),
      'copyFailedText' => __(
...
add_action('admin_enqueue_scripts', 'vz_enqueue_privacy_admin_assets');
...
function vz_privacy_settings_page() {
  ...
  <div class="wrap">
    ...
    <div class="vz-privacy-intro">
      <p>
        <?php _e(
          'Configure privacy and data protection settings for ' .
          'Viroz Secure Video. These settings help you comply with ' .
    ...
    <form method="post" action="options.php">
      ...
      <p class="description">
        <?php _e(
          'Enable GDPR compliance features if you serve users in ' .
          'the European Union.',
          'vz-secure-video'
        ); ?>
      </p>
        ...
        <tr>
          <th scope="row">
            <label for="vz_gdpr_enabled">
              <?php _e('GDPR Compliance Mode', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                'When enabled, this activates GDPR-specific features ' .
                'including explicit consent requirements, data export/' .
                'deletion capabilities, and enhanced privacy controls.',
                'vz-secure-video'
              ); ?>
            </p>
          </td>
        ...
        <tr>
          <th scope="row">
            <label for="vz_require_explicit_consent">
              <?php _e('Explicit Consent', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
              ...
              value="1"
              <?php checked(
                get_option('vz_require_explicit_consent'),
                1
              ); ?>
            >
            <label for="vz_require_explicit_consent">
            ...
            <p class="description">
              <?php _e(
                'Users must explicitly opt-in before any personal data ' .
                'is collected. Recommended for GDPR compliance.',
                'vz-secure-video'
              ); ?>
            </p>
          </td>
      ...
      <p class="description">
        <?php _e(
          'Control what data is collected from users. Collect only ' .
          'what you need for your specific use case.',
          'vz-secure-video'
        ); ?>
      </p>
        ...
        <tr>
          <th scope="row">
            <label for="vz_track_ip">
              <?php _e('IP Address Tracking', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                'IP addresses are used for security (preventing ' .
                'unauthorized access) and analytics. Required for ' .
                'security but can be anonymized.',
                'vz-secure-video'
              ); ?>
            </p>
          </td>
        ...
        <tr>
          <th scope="row">
            <label for="vz_anonymize_ip">
              <?php _e('Anonymize IP Addresses', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                'Removes the last octet of IP addresses to reduce ' .
                'identifiability while maintaining security ' .
                'functionality. Recommended for GDPR compliance.',
                'vz-secure-video'
              ); ?>
            </p>
          </td>
        ...
        <tr>
          <th scope="row">
            <label for="vz_track_user_agent">
              <?php _e('User Agent Tracking', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                'User agent information helps with compatibility ' .
                'debugging and device analytics. Not required for ' .
      ...
      <p class="description">
        <?php _e(
          'Automatically delete old data to reduce storage and ' .
      ...
      <table class="form-table" role="presentation">
        <tr>
          <th scope="row">
            <label for="vz_auto_cleanup_enabled">
              <?php _e('Automatic Cleanup', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                'Automatically delete old view logs based on the ' .
        ...
        <tr>
          <th scope="row">
            <label for="vz_log_retention_days">
              <?php _e('Data Retention Period', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <select id="vz_log_retention_days" name="vz_log_retention_days">
              <option value="0" <?php selected(
                get_option('vz_log_retention_days'),
                0
              ); ?>>
            ...
            <p class="description">
              <?php _e(
                'View logs older than this period will be ' .
                'automatically deleted. Recommended: 90-365 days ' .
                'for most use cases.',
                'vz-secure-video'
              ); ?>
            </p>
      ...
      <p class="description">
        <?php _e(
          'Enable users to exercise their privacy rights under GDPR ' .
      ...
      <table class="form-table" role="presentation">
        <tr>
          <th scope="row">
            <label for="vz_allow_data_export">
              <?php _e('Data Export', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                'Users can request a copy of all their data in JSON ' .
                'or CSV format. Required for GDPR compliance.',
                'vz-secure-video'
              ); ?>
            </p>
          </td>
        ...
        <tr>
          <th scope="row">
            <label for="vz_allow_data_deletion">
              <?php _e('Data Deletion', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
            ...
            <p class="description">
              <?php _e(
                ...
                '("right to be forgotten"). Required for GDPR compliance.',
                'vz-secure-video'
              ); ?>
            </p>
          </td>
        ...
        <tr>
          <th scope="row">
            <label for="vz_privacy_policy_url">
              <?php _e('Privacy Policy URL', 'vz-secure-video'); ?>
            </label>
          </th>
          <td>
            <input
              ...
              value="<?php echo esc_attr(
                get_option('vz_privacy_policy_url')
              ); ?>"
              class="regular-text"
            ...
            <p class="description">
              <?php _e(
                'Link to your privacy policy page. This will be ' .
                'shown to users when they request data export or deletion.',
                'vz-secure-video'
              ); ?>
            </p>
            <p>
              ...
              >
                ...
                ></span>
                <?php _e('View Privacy Policy Templates', 'vz-secure-video'); ?>
              </button>
            </p>
          </td>
        </tr>
    ...
    <div class="vz-privacy-footer">
      ...
      <ul>
        <li>
          <?php _e(
            '✓ Collect only the data you need for your specific use case',
            'vz-secure-video'
          ); ?>
        </li>
        <li>
          <?php _e(
            '✓ Use IP anonymization if you don\'t need full IP addresses',
            'vz-secure-video'
          ); ?>
        </li>
        <li>
          <?php _e(
            ...
            '(90-365 days recommended)',
            'vz-secure-video'
          ); ?>
        </li>
        <li>
          <?php _e(
            '✓ Enable GDPR mode if you serve EU users',
            'vz-secure-video'
          ); ?>
        </li>
        <li>
        ...
        <li>
          <?php _e(
            '✓ Enable automatic cleanup to reduce storage costs',
            'vz-secure-video'
          ); ?>
        </li>
      </ul>
    ...
    <div class="vz-privacy-legal-notice">
      ...
      <p>
        <?php _e(
          'This plugin provides tools to help with privacy compliance, ' .
          'but it does not constitute legal advice. You are responsible ' .
          'for ensuring your site complies with all applicable privacy ' .
          'laws (GDPR, CCPA, etc.). We recommend consulting with a legal ' .
